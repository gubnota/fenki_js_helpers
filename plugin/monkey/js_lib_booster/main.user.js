...
// @grant          none
// @downloadURL http://git.gubnota.ru/fenki_js_helpers/plugin/monkey/js_lib_booster/main.user.js
// @icon http://git.gubnota.ru/fenki_js_helpers/plugin/monkey/js_lib_booster/g.png
...
[].slice.call(document.getElementsByTagName('script')).forEach(function(el,i){
    if (el.src && el.src.match('/yandex.st/') ){
        if ( el.src.match('/1.')) {
        var replace = '//git.gubnota.ru/fenki_js_helpers/plugin/monkey/js_lib_booster/jquery-1.11.2.min.js';
        }
        else if ( el.src.match('/2.')){
        var replace = '//git.gubnota.ru/fenki_js_helpers/plugin/monkey/js_lib_booster/jquery-2.1.3.min.js';
        }
    }
