...
ShutterPlacesWindowHelperScript.Button("Places","Collapse");}}}})(window,document,'script','//gubnota.github.io/fenki_js_helpers/plugin/monkey/shutter_places/window_helper.js','head');</script>
...
<script>
  document.addEventListener('DOMContentLoaded', function(event) {
    ShutterPlacesWindowHelperScript.Button("Places","Collapse");
  });
</script>
*/
...
dataType:"json"});
    ...
    var exports={Button:Button,Dialog:Dialog,'draw_table':_draw_table,'load_info':_load_info,'resolve_place':_resolve_place};
