...
(function(window) {
    ...
    var ShutterPlacesWindowHelperScript = (function() {
        ...
        'tr':['Yerler','Yakın','Küçük resim','Sitedeki benzer','Kim resmi kullanır','Zaman','Yer'],
...
//                                place = 'https://www.google.com/maps/@' + data[i].latitude + ',' + data[i].longitude + ',11z';
                            ...
                            jQuery('#' + TranslateIframeId + ' table').append('<tr class="' + i + '" style="max-height:40px;">' + '<td class="thumb" style="width:105px"><a href="http://www.shutterstock.com/pic-' + i + '/index.html" target="_blank"><img src="' + data[i].thumb_url + '"></a></td>' + '<td class="similar"><a href="http://www.shutterstock.com/similar-' + i + '/index.html" target="_blank">Shutterstock</a></td>' + '<td class="google"><a href="https://www.google.com/searchbyimage?&amp;image_url=' + window.encodeURI('http://thumb101.shutterstock.com/display_pic_with_logo/0/0/' + i + '.jpg') + '" target="_blank">Google images</a></td>' + '<td class="time" style="max-width:80px">' + (new Date(data[i].time * 1000)) + '</td>' + '<td class="place" style="max-width:100px;">' + place + '</td>' + '</tr>');
                            if(data[i].longitude !== null)
                            ShutterPlacesWindowHelperScript.resolve_place(jQuery('#' + TranslateIframeId + ' table .' + i + ' .place a'), data[i].longitude, data[i].latitude, 11);
                        };
                    },
                    cache: false,
                    crossDomain: true,
